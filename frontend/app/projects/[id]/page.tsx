...
export default function ProjectDashboard() {
  ...
  // Load available tools and select all by default
  useEffect(() => {
    const loadTools = async () => {
      try {
        ...
        if (response.ok) {
          ...
          if (data.enabled && data.servers) {
            // Get all tool names from all servers
            const allToolNames = Object.values(data.servers)
              .flat()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 text-gray-600 hover:text-sky-600 hover:bg-sky-100 rounded-lg transition-all"
      ...
      <ToolSelectionModal
        ...
        onSave={(tools) => setSelectedTools(tools)}
      />
      ...
      <ConfirmModal
        ...
        title="Clear Chat History"
        message="Are you sure you want to clear all chat messages? This will start a fresh conversation with the Director. This action cannot be undone."
